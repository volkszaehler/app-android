...
public class VolkszaehlerPreferences extends PreferenceActivity
{
	...
	private class GetChannels extends AsyncTask<Void, Void, String>
	{
		...
		protected void onPreExecute()
		{
			...
			pDialog = new ProgressDialog(VolkszaehlerPreferences.this);
		...
		protected String doInBackground(Void... arg0)
		{
			...
			SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(VolkszaehlerPreferences.this);
		...
		protected void onPostExecute(String result)
		{
			...
			if (JSONFehler || JSONFehler2)
			{
				if (JSONFehler)
				{
					new AlertDialog.Builder(VolkszaehlerPreferences.this).setTitle(getString(R.string.Error)).setMessage(fehlerAusgabe).setNeutralButton(getString(R.string.Close), null).show();
				}
				if (JSONFehler2)
				{
					new AlertDialog.Builder(VolkszaehlerPreferences.this).setTitle(getString(R.string.Error)).setMessage(fehlerAusgabe2).setNeutralButton(getString(R.string.Close), null).show();
				}
			}
			else
			{
